function [u, eu, ev, eh, esp] = bilateral_hiding(delta1, delta2, alpha, y0, rho, p, q) 
% Bilateral Income Hiding with square root utility
% April 23, 2020
...
c1_fb = alpha.^2.*inc./alpha_con;
c2_fb = (1-alpha).^2.*inc./alpha_con;
% utility
u_fb = c1_fb.^0.5;
v_fb = c2_fb.^0.5;
% resource shares
...
if tot_ic == 0
    ...
    fun = @(x) honest(x,alpha,delta1,delta2,inc,rho,prob);
    x0 = c1_fb(1,1);
